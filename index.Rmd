...
```{r message=FALSE, warning=FALSE, fig.align="center", fig.width=10, fig.height=6,  tidy=TRUE}
...
ggplot(df_new_sample, aes(x=age, col=stroke)) +
  ...
  labs(title="BMI, glucose levels vs age and stroke occurence",
       subtitle = paste(
       "Mean avg glucose level ( stroke = ",means_stroke$avg_glucose_level,
...
```{r message=FALSE, warning=FALSE, fig.align="center", fig.width=9, fig.height=4,  tidy=TRUE}
#stacked barchart
...
p2 + geom_bar(
  ...
  scale_fill_viridis_d( 
    ...
    limits = c("Unknown","smokes","never smoked", "formerly smoked", 
               "Male", "Female", "Urban","Rural", "Self-employed",  
               "Private","Govt_job", "children", "Yes", "No")) +
